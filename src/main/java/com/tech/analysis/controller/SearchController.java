...
//    @ResponseBody
    @RequestMapping("/creatyangqi_index")
...
//    @ResponseBody
    @RequestMapping("/creatpaper_index")
    public String creatpaper_index() {
        String data=DoIndexService.creat_paperIndex();
        return data;
    }

    @RequestMapping("/creat_yangqipaperIndex")
    public String creat_yangqipaperIndex() {
        String data=DoIndexService.creat_yangqipaperIndex();
        return data;
    }
    //删除索引
...
//    @ResponseBody
    @RequestMapping("/deleteyangqi_index")
...
//    @ResponseBody
    @RequestMapping("/deletepaper_index")
